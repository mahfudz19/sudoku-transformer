...
from utilGetData import create_output_directories, fetch_stock_data, normalize_data, create_sequences, split_data
...
if __name__ == "__main__":
    ...
    if x is None or y is None:
        print("❌ Gagal membuat sequences. Data tidak cukup untuk window size yang dipilih.")
        sys.exit(1)
